...
namespace BogsyVideoStore.Classes
{
    public class Queries
    {
        ...
        public static string UpdateRentalTable { get; } = "UPDATE RentalTable SET PenaltyFee = (DATEDIFF(DAY, DueDate, GETDATE()) * 5), Status = 'Overdue' WHERE ReturnDate IS NULL AND DueDate < GETDATE()";
